      ...
      if (res.ok) {
        res.json().then((data) => {
          if (type === "friend") {
            ...
            setFriendList((prevState) =>
              prevState.filter((state) => state.id !== friend.id)
            );
            setBlockList((prevState) => [...prevState, friend]);
          } else {
            setBlockList((prevState) =>
              prevState.filter((state) => state.id !== data.friendId)
            );
          }
        });
      }
  ...
  return (
    <MainLayout>
      <div className="profile-container">
        <h1 ref={header} className="profile">
          profile
        </h1>
        <div>
          <input
        ...
        <form ref={form} onSubmit={handleProfileSubmit}>
          ...
          <input
            ...
            defaultValue={new Date(user.birthdate).toLocaleDateString("en-Us", {
              year: "numeric",
              month: "long",
              day: "numeric",
            })}
                ...
                <tr key={friend.conversationId}>
                  ...
                  <td>
                    ...
                    <input
                      ...
                      onClick={(e) =>
                        handleFriendStatus(e, friend, "blockFriend")
                      }
                    />
                  </td>
                </tr>
                ...
                <tr key={`${block.conversationId}block`}>
                  ...
                  <td>
                    <input
                      ...
                      onClick={(e) => handleFriendStatus(e, block, "block")}
                    />
                  </td>
                </tr>
              ))}
